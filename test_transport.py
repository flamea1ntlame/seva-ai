...
async def test():
    async with AsyncSessionLocal() as db:
        ...
        # Get service
        res = await db.execute(select(Service).where(Service.code == "driving_license"))
        ...
        # Submit
        res = await connector.submit_application({"application_id": "123e4567-e89b-12d3-a456-426614174000", "form_data": {}, "documents": ["identity_proof"]})
